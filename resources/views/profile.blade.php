                            ...
                            <div class="flex justify-center items-center gap-2">
                                ...
                                <div class="flex justify-center m-5">
                                    <button id="deleteButton" data-modal-target="deleteModal" data-modal-toggle="deleteModal"
                                            class="block text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300
                                ...
                                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                    <!-- Close Button -->
                                    <button type="button" class="absolute top-2.5 right-2.5 text-gray-400 bg-transparent
                                            hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 dark:hover:bg-gray-600
                                    ...
                                    <form method="POST" action="{{ route('articles.delete', $article->id) }}">
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            ...
                                            <button type="button" data-modal-toggle="deleteModal"
                                                    class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg
                                                    border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none
                                                    focus:ring-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500
