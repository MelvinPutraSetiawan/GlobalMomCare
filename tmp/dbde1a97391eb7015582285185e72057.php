<?php $__env->startSection('title', 'Update Article'); ?>

<?php $__env->startSection('content'); ?>
<div class="container p-8">
    <h2 class="text-3xl font-bold mb-6 text-center text-gray-800">Update Article</h2>
    ...
    <form method="POST" action="<?php echo e(route('articles.update', $article->id)); ?>" enctype="multipart/form-data" class="space-y-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center mb-3">
                                <input type="checkbox" id="category<?php echo e($category->id); ?>" name="categories[]" value="<?php echo e($category->id); ?>"
                                    ...
                                    <?php echo e(in_array($category->id, $article->categories->pluck('id')->toArray()) ? 'checked' : ''); ?>>
            ...
            <div class="col-span-2">
                <div class="mb-6">
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title', $article->title)); ?>" class="w-full p-3 border rounded-lg shadow-sm" placeholder="Enter the article title" required>
                </div>

                <div class="pt-4 h-auto">
                    <label for="content" class="block text-lg font-medium text-gray-700 mb-2">Content</label>
                    <textarea name="content" id="content" rows="8" class="w-full p-3 border rounded-lg shadow-sm" placeholder="Write your article here..." required><?php echo e(old('content', $article->content)); ?></textarea>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Melvin\Documents\GitHub\GlobalMomsCare\resources\views\article\update.blade.php ENDPATH**/ ?>