...
<div class="container p-8">
    <h2 class="text-3xl font-bold mb-6 text-center text-gray-800">Create a New Product</h2>
    ...
    <form method="POST" action="<?php echo e(route('products.store')); ?>" enctype="multipart/form-data" class="space-y-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="col-span-2">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" class="w-full p-3 border rounded-lg shadow-sm" placeholder="Enter the product name" required>
                </div>

                <!-- Price Product Input -->
                <div class="mb-6">
                    <label for="price" class="block text-lg font-medium text-gray-700 mb-2">Product Price</label>
                    <input type="text" name="price" id="price" class="w-full p-3 border rounded-lg shadow-sm" placeholder="Enter the product price" required>
                </div>

                <!-- Stock Product Input -->
                <div class="mb-6">
                    <label for="stock" class="block text-lg font-medium text-gray-700 mb-2">Product Stock</label>
                    <input type="number" name="stock" id="stock" class="w-full p-3 border rounded-lg shadow-sm" placeholder="Enter the product stock quantity" required>
                </div>
                ...
                <div class="pt-4 h-auto">
                    ...
                    <textarea name="description" id="description" rows="8" class="w-full p-3 border rounded-lg shadow-sm" placeholder="Write your product description here..." required></textarea>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Melvin\Documents\GitHub\GlobalMomsCare\resources\views\product\create.blade.php ENDPATH**/ ?>