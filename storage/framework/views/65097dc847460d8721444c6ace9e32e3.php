                    ...
                    <div class="divide-y divide-gray-200 dark:divide-gray-700">
                        <div class="flex flex-wrap items-center gap-y-4 py-6">
                            ...
                            <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
                                <a href="#" class="hover:underline">#<?php echo e($order->id); ?></a>
                            </dd>
                            </dl>

                            <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Date:</dt>
                            <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white"><?php echo e($order->created_at->format('d.m.Y')); ?></dd>
                            </dl>
                            ...
                            ?>
                            <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></dd>
                            </dl>

                            <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Status:</dt>
                                <?php if($order->status == "Waiting Payment"): ?>
                                ...
                                <?php elseif($order->status == "Processing Order"): ?>
                            ...
                            <div class="w-full grid sm:grid-cols-2 lg:flex lg:w-64 lg:items-center lg:justify-end gap-4">
                                ...
                                <?php endif; ?>
                                <?php if($order->status == "Processing Order" && auth()->user()->role == "admin"): ?>
                                    <form action="<?php echo e(route('orders.process.deliver', $order->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="w-full rounded-lg border border-red-700 px-3 py-2 text-center text-sm font-medium text-red-700 hover:bg-red-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-red-300 dark:border-red-500 dark:text-red-500 dark:hover:bg-red-600 dark:hover:text-white dark:focus:ring-red-900 lg:w-auto text-nowrap">Process & Deliver</button>
                                    </form>
                                <?php endif; ?>
                                <?php if($order->status == "Shipping" && auth()->user()->role == "admin"): ?>
                                    <form action="<?php echo e(route('orders.completed', $order->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Melvin\Documents\GitHub\GlobalMomsCare\resources\views\order\order.blade.php ENDPATH**/ ?>