...
<body class="relative bg-cover bg-center min-h-screen flex items-center justify-center" style="background-image: url('/images/auth/bg.jpg');">
    ...
    <div class="glass bg-white/30 rounded-lg shadow-lg flex max-w-4xl w-full overflow-hidden relative z-10">
        ...
        <div class="hidden md:flex flex-1 items-center justify-center relative">
            ...
            <img src="<?php echo e(asset('images/auth/login.png')); ?>" alt="Illustration" class="relative w-auto h-4/4 z-10">
        </div>
        ...
        <div class="w-full md:w-1/2 p-8">
            ...
            <?php if($errors->has('login_error')): ?>
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4 mt-4">
                    <strong><?php echo e($errors->first('login_error')); ?></strong>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="mt-8">
                ...
                <div class="mb-4">
                    ...
                    <input id="email" type="email" name="email" placeholder="john@gmail.com" value="<?php echo e(old('email')); ?>" class="w-full p-3 border rounded focus:outline-none focus:ring-2 focus:ring-purple-500" required>
                </div>
            ...
            <div class="flex mt-3">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-red-500 font-bold">Register</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Melvin\Documents\GitHub\GlobalMomsCare\resources\views\auth\login.blade.php ENDPATH**/ ?>